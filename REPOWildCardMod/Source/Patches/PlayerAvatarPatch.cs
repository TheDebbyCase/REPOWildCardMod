...
namespace REPOWildCardMod.Patches
{
    ...
    public static class PlayerAvatarPatch
    {
        ...
        {
            if (__instance.physGrabber != null && __instance.physGrabber.grabbedPhysGrabObject != null && __instance.physGrabber.grabbedPhysGrabObject.transform.TryGetComponent<SmithNote>(out SmithNote smithNote) && smithNote.itemToggle.toggleState && smithNote.charged && SemiFunc.RunIsLevel())
            {
