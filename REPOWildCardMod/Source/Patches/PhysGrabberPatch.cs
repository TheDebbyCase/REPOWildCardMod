...
namespace REPOWildCardMod.Patches
{
    ...
    public static class PhysGrabberPatch1
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                if (codes[i].ToString() == "callvirt PhysGrabObject UnityEngine.Component::GetComponent()" && codes[i + 1].ToString() == "stloc.s 20 (PhysGrabObject)")
                {
    ...
    [HarmonyPatch(typeof(PhysGrabber))]
    public static class PhysGrabberPatch2
    {
        static readonly BepInEx.Logging.ManualLogSource log = WildCardMod.instance.log;
